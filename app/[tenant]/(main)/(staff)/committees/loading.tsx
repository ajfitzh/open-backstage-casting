    ...
    <div className="p-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="h-12 bg-zinc-100 rounded-lg w-full mb-6"></div> {/* Search Bar */}
          
          {/* Fake Rows */}
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="bg-white border border-zinc-200 p-4 rounded-xl flex justify-between items-center">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-zinc-200 rounded-full"></div>
                <div>
                  <div className="h-5 bg-zinc-200 rounded w-40 mb-2"></div>
                  <div className="h-4 bg-zinc-100 rounded w-24"></div>
                </div>
              </div>
              <div className="h-8 bg-zinc-100 rounded w-32"></div>
            </div>
          ))}
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white border border-zinc-200 p-6 rounded-xl">
             ...
             <div className="h-24 bg-zinc-100 rounded w-full mb-4"></div>
